...
export const DataFlowGraphic: React.FC = () => {
  ...
  return (
    <div className="relative w-full rounded-2xl bg-[#FFFFFF] p-5 sm:p-6 lg:p-7 overflow-hidden border border-[#D8C7AD] shadow-md shadow-[#4B382C]/5">
      {/* Background ambient lighting */}
      <div className="absolute -top-24 -right-24 w-72 h-72 bg-[#A8B5A2]/20 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute -bottom-24 -left-24 w-72 h-72 bg-[#E6D8C3]/40 rounded-full blur-3xl pointer-events-none" />

      {/* Header bar */}
      <div className="flex items-center justify-between pb-5 border-b border-[#D8C7AD]/60 mb-6">
        ...
        <div className="flex items-center gap-1.5 font-mono text-[11px] text-[#4F5A3D] bg-[#F2EBDD] px-2.5 py-1 rounded-full border border-[#D8C7AD]">
          ...
          return (
            <motion.div
              ...
              className={`relative cursor-pointer group p-4 rounded-xl transition-all duration-300 border ${
                isSelected
                  ? 'bg-[#F7F3EA] border-[#68724F] shadow-sm ring-1 ring-[#68724F]/30'
                  : 'bg-[#F7F3EA]/70 hover:bg-[#FFFFFF] border-[#D8C7AD]/70 hover:border-[#68724F]/50'
              }`}
              whileHover={{ y: -3 }}
            >
              <div className="flex items-center justify-between mb-3">
                <div className="w-9 h-9 rounded-lg flex items-center justify-center bg-[#F2EBDD] border border-[#D8C7AD] text-[#4F5A3D] font-bold group-hover:bg-[#4F5A3D] group-hover:text-[#F7F3EA] transition-colors">
              ...
              <div className="text-left">
                ...
                <p className="text-[11px] text-[#6F675D] mt-2 leading-relaxed line-clamp-2">
                  {step.details}
                </p>
              </div>
              ...
              {idx < steps.length - 1 && (
                <div className="hidden lg:block absolute -right-3 top-1/2 -translate-y-1/2 z-10 pointer-events-none text-[#D8C7AD]">
