...
export const Education: React.FC = () => {
  return (
    <section id="education" className="py-20 md:py-28 relative bg-[#EAE2D2] border-t border-[#C9B89E]/70">
            ...
            >
              <div>
                <div className="flex items-center justify-between mb-4">
                  <div className="w-10 h-10 rounded-xl bg-[#E1D7C4] border border-[#C9B89E] flex items-center justify-center text-[#4F5A3D] group-hover:border-[#68724F]/40 transition-colors">
              ...
              <div className="mt-6 pt-4 border-t border-[#C9B89E]/60 flex items-center justify-between font-mono text-xs text-[#765C48]">
                <span className="flex items-center gap-1.5 text-[#665E55]">
