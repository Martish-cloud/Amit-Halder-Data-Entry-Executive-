...
export const About: React.FC = () => {
  ...
  return (
    <section id="about" className="py-20 md:py-28 relative bg-[#F2EBDD]/80 backdrop-blur-sm border-t border-[#D8C7AD]/60">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-16">
          {VERIFIED_CV_METRICS.map((item, idx) => (
            <motion.div
              ...
              className="bg-[#FFFFFF] p-5 rounded-2xl border border-[#D8C7AD] text-left hover:border-[#68724F]/50 shadow-xs hover:shadow-md transition-all group"
            >
              ...
              <div className="text-xs text-[#6F675D] mt-1 leading-snug">
                {item.detail}
              </div>
            </motion.div>
          ))}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start mb-16">
          ...
          <div className="lg:col-span-6 bg-[#FFFFFF] p-6 sm:p-8 rounded-2xl border border-[#D8C7AD] text-left space-y-4 shadow-sm">
            <h3 className="text-lg font-bold text-[#4B382C] flex items-center gap-2.5">
              <Award className="w-5 h-5 text-[#68724F]" />
              <span>Executive Summary</span>
            </h3>
            <div className="text-sm sm:text-base text-[#6F675D] leading-relaxed space-y-4 font-normal">
              <p>
                {PERSONAL_INFO.summary}
              </p>
              <div className="p-4 rounded-xl bg-[#F7F3EA] border border-[#D8C7AD] text-xs text-[#4B382C] font-mono space-y-2">
            ...
            {STRENGTHS.map((strength, idx) => {
              ...
              return (
                <motion.div
                  ...
                  className="bg-[#FFFFFF] p-5 rounded-xl border border-[#D8C7AD] text-left hover:border-[#68724F]/50 shadow-xs hover:shadow-sm transition-all"
                >
                  <div className="w-9 h-9 rounded-lg bg-[#F2EBDD] border border-[#D8C7AD] flex items-center justify-center mb-3 text-[#4F5A3D]">
                    <Icon className="w-4 h-4" />
                  </div>
                  <h4 className="text-sm font-bold text-[#29261F]">
                    {strength.title}
                  </h4>
                  <p className="text-xs text-[#6F675D] mt-1.5 leading-relaxed">
                    {strength.desc}
                  </p>
                </motion.div>
              );
        ...
        <div className="space-y-6 text-left">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-[#D8C7AD] pb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
            {OPERATIONAL_PILLARS.map((pillar, i) => (
              <motion.div
                ...
                className="bg-[#FFFFFF] p-5 rounded-xl border border-[#D8C7AD] hover:border-[#68724F]/50 shadow-xs hover:shadow-md transition-all flex flex-col justify-between group"
              >
                <div>
                ...
                <div className="mt-5 pt-3 border-t border-[#D8C7AD]/60 space-y-1.5">
